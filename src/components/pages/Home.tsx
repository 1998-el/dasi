...
export const Home: React.FC = () => {
  ...
  return (
    <div ref={homeRef} className="min-h-screen bg-white">
      {/* Navigation */}
      <Navbar />
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              >
                ...
                <h3 className="text-3xl font-bold text-gray-50 mb-2">{stat.number}</h3>
                <p className="text-gray-100">{stat.text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              { icon: 'users', title: 'Client Centric', description: 'Nous plaçons les besoins de nos clients au cœur de nos solutions, offrant un accompagnement personnalisé et des réponses adaptées.' }
            ].map((item, index) => (
              <div 
                key={index} 
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-orange-500 transition-colors">Collecte de données</a></li>
                <li><a href="#" className="hover:text-orange-500 transition-colors">Analyse spatiale</a></li>
                <li><a href="#" className="hover:text-orange-500 transition-colors">Solutions sur mesure</a></li>
                <li><a href="#" className="hover:text-orange-500 transition-colors">Formations</a></li>
              </ul>
            </div>
