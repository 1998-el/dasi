            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-[#1067a8]/10 rounded-lg flex items-center justify-center flex-shrink-0">
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  ...
                  className="w-10 h-10 bg-[#1067a8]/10 rounded-lg flex items-center justify-center hover:bg-[#1067a8] hover:text-white transition-colors"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    required
                    className="w-full px-4 py-2 bg-white border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#1067a8] focus:border-transparent transition-all"
                  >
                ...
                <Button
                  ...
                  className="w-full bg-[#1067a8] hover:bg-[#1067a8]/90 text-white"
                >
                  {isSubmitting ? (
